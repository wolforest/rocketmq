...
public abstract class RebalanceImpl {
    ...
    public void unlockAll(final boolean oneway) {
        ...
        for (final Map.Entry<String, Set<MessageQueue>> entry : brokerMqs.entrySet()) {
            ...
            FindBrokerResult findBrokerResult = this.mQClientFactory.findBrokerAddressInSubscribe(brokerName, MQConstants.MASTER_ID, true);
            if (findBrokerResult != null) {
                UnlockBatchRequestBody requestBody = new UnlockBatchRequestBody();
                requestBody.setConsumerGroup(this.consumerGroup);
                requestBody.setClientId(this.mQClientFactory.getClientId());
    ...
    public void lockAll() {
        ...
        for (Entry<String, Set<MessageQueue>> entry : brokerMqs.entrySet()) {
            ...
            FindBrokerResult findBrokerResult = this.mQClientFactory.findBrokerAddressInSubscribe(entry.getKey(), MQConstants.MASTER_ID, true);
            if (findBrokerResult == null) {
                continue;
            }
