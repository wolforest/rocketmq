...
public class NamespaceRpcHook implements RPCHook {
    ...
    public void doBeforeRequest(String remoteAddr, RemotingCommand request) {
        if (StringUtils.isNotEmpty(clientConfig.getNamespaceV2())) {
            request.addExtField(MQConstants.RPC_REQUEST_HEADER_NAMESPACED_FIELD, "true");
            request.addExtField(MQConstants.RPC_REQUEST_HEADER_NAMESPACE_FIELD, clientConfig.getNamespaceV2());
        }
    }
