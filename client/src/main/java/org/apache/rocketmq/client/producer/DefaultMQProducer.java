...
public class DefaultMQProducer extends ClientConfig implements MQProducer {
    ...
    public DefaultMQProducer() {
        this(null, MQConstants.DEFAULT_PRODUCER_GROUP, null);
    }
    ...
    public DefaultMQProducer(RPCHook rpcHook) {
        this(null, MQConstants.DEFAULT_PRODUCER_GROUP, rpcHook);
    }
    ...
    private boolean canBatch(Message msg) {
        ...
        if (msg.getTopic().startsWith(MQConstants.RETRY_GROUP_TOPIC_PREFIX)) {
            return false;
        }
