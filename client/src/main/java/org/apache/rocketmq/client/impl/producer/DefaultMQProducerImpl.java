...
public class DefaultMQProducerImpl implements MQProducerInner {
    ...
    private void startAfterCreation(final boolean startFactory) throws MQClientException {
        ...
        if (!this.defaultMQProducer.getProducerGroup().equals(MQConstants.CLIENT_INNER_PRODUCER_GROUP)) {
    ...
    private void checkConfig() throws MQClientException {
        ...
        if (this.defaultMQProducer.getProducerGroup().equals(MQConstants.DEFAULT_PRODUCER_GROUP)) {
            throw new MQClientException("producerGroup can not equal " + MQConstants.DEFAULT_PRODUCER_GROUP + ", please specify another one.",
                null);
        }
    }
    ...
    public void checkTransactionState(final String addr, final MessageExt msg,
        ...
        Runnable request = new Runnable() {
            ...
            private void processTransactionState(
                ...
                String remark = null;
                if (exception != null) {
                    remark = "checkLocalTransactionState Exception: " + IOUtils.exceptionSimpleDesc(exception);
                }
    ...
    private SendResult sendKernelImpl(final Message msg,
        ...
        brokerAddr = NetworkUtils.brokerVIPChannel(this.defaultMQProducer.isSendMessageWithVIPChannel(), brokerAddr);
    ...
    private void prepareSendRequest(final Message msg, long timeout) {
        String correlationId = StringUtils.UUID();
