...
public class NamespaceRpcHookTest {
    ...
    public void testDoBeforeRequestWithNamespace() {
        ...
        assertThat(request.getExtFields().get(MQConstants.RPC_REQUEST_HEADER_NAMESPACED_FIELD)).isEqualTo("true");
        assertThat(request.getExtFields().get(MQConstants.RPC_REQUEST_HEADER_NAMESPACE_FIELD)).isEqualTo(namespace);
    }
