...
public class MQClientAPIImplTest {
    ...
    public void testPopLmqMessage_async() throws Exception {
        final long popTime = System.currentTimeMillis();
        final int invisibleTime = 10 * 1000;
        final String lmqTopic = MQConstants.LMQ_PREFIX + "lmq1";
        doAnswer((Answer<Void>) mock -> {
            InvokeCallback callback = mock.getArgument(3);
            RemotingCommand request = mock.getArgument(1);
            ResponseFuture responseFuture = new ResponseFuture(null, request.getOpaque(), 3 * 1000, null, null);
    ...
    public void testPopMultiLmqMessage_async() throws Exception {
        ...
        final int invisibleTime = 10 * 1000;
        final String lmqTopic = MQConstants.LMQ_PREFIX + "lmq1";
        final String lmqTopic2 = MQConstants.LMQ_PREFIX + "lmq2";
        final String multiDispatch = String.join(MQConstants.LMQ_DISPATCH_SEPARATOR, lmqTopic, lmqTopic2);
        final String multiOffset = String.join(MQConstants.LMQ_DISPATCH_SEPARATOR, "0", "0");
        doAnswer((Answer<Void>) mock -> {
            InvokeCallback callback = mock.getArgument(3);
            RemotingCommand request = mock.getArgument(1);
            ResponseFuture responseFuture = new ResponseFuture(null, request.getOpaque(), 3 * 1000, null, null);
    ...
    public void assertPullMessage() throws MQBrokerException, RemotingException, InterruptedException {
        ...
        when(responseHeader.getSuggestWhichBrokerId()).thenReturn(MQConstants.MASTER_ID);
    ...
    public void testRemoveBroker() throws RemotingException, InterruptedException, MQBrokerException {
        mockInvokeSync();
        mqClientAPI.removeBroker(defaultBrokerAddr, clusterName, brokerName, MQConstants.MASTER_ID, defaultTimeout);
    }
    ...
    public void assertGetAllSubscriptionGroupForSubscriptionGroupConfig() throws RemotingException, InterruptedException, MQBrokerException {
        ...
        responseBody.setBrokerId(MQConstants.MASTER_ID);
        setResponseBody(responseBody);
        ...
        assertEquals(MQConstants.MASTER_ID, actual.getBrokerId());
    }
    ...
    public void assertGetInSyncStateData() throws RemotingException, InterruptedException, MQBrokerException {
        ...
        BrokerReplicasInfo.ReplicasInfo replicasInfo = new BrokerReplicasInfo.ReplicasInfo(MQConstants.MASTER_ID, defaultBrokerAddr, 1, 1, Collections.emptyList(), Collections.emptyList());
    ...
    public void assertGetBrokerEpochCache() throws RemotingException, InterruptedException, MQBrokerException {
        mockInvokeSync();
        EpochEntryCache responseBody = new EpochEntryCache(clusterName, brokerName, MQConstants.MASTER_ID, Collections.emptyList(), 1);
        setResponseBody(responseBody);
    ...
    public void assertElectMaster() throws RemotingException, InterruptedException, MQBrokerException {
        ...
        Pair<ElectMasterResponseHeader, BrokerMemberGroup> actual = mqClientAPI.electMaster(defaultBrokerAddr, clusterName, brokerName, MQConstants.MASTER_ID);
        assertNotNull(actual);
