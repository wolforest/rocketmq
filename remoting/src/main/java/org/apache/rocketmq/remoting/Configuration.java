...
public class Configuration {
    ...
    public Configuration registerConfig(Object configObject) {
        try {
            ...
            try {
                ...
                Properties registerProps = BeanUtils.object2Properties(configObject);
        ...
        try {
            ...
            try {
                ...
                for (Object configObject : configObjectList) {
                    ...
                    BeanUtils.properties2Object(properties, configObject);
                }
    ...
    private String getAllConfigsInternal() {
        ...
        for (Object configObject : this.configObjectList) {
            Properties properties = BeanUtils.object2Properties(configObject);
            if (properties != null) {
        ...
        {
            stringBuilder.append(BeanUtils.properties2String(this.allConfigs, true));
        }
    ...
    private String getClientConfigsInternal(List<String> clientConigKeys) {
        ...
        stringBuilder.append(BeanUtils.properties2String(clientProperties));
