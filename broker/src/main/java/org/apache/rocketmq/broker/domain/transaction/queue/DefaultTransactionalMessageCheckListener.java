    ...
    public void resolveDiscardMsg(MessageExt msgExt) {
        ...
        try {
            ...
            if (putMessageResult != null && putMessageResult.getPutMessageStatus() == PutMessageStatus.PUT_OK) {
                ...
                this.getBrokerController().getBrokerMessageService().getTransactionalMessageService().getTransactionMetrics().addAndGet(msgExt.getUserProperty(MessageConst.PROPERTY_REAL_TOPIC), -1);
            } else {
