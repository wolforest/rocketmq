...
public class ExpressionForRetryMessageFilter extends ExpressionMessageFilter {
    ...
    public boolean isMatchedByCommitLog(ByteBuffer msgBuffer, Map<String, String> properties) {
        ...
        boolean isRetryTopic = subscriptionData.getTopic().startsWith(MQConstants.RETRY_GROUP_TOPIC_PREFIX);
        ...
        if (isRetryTopic) {
            ...
            String group = subscriptionData.getTopic().substring(MQConstants.RETRY_GROUP_TOPIC_PREFIX.length());
