...
import static org.apache.rocketmq.broker.server.longpolling.PollingResult.NOT_POLLING;
import static org.apache.rocketmq.broker.server.longpolling.PollingResult.POLLING_FULL;
import static org.apache.rocketmq.broker.server.longpolling.PollingResult.POLLING_SUC;
import static org.apache.rocketmq.broker.server.longpolling.PollingResult.POLLING_TIMEOUT;
...
public class PopLongPollingService extends ServiceThread {
    ...
    public PopLongPollingService(Broker broker, NettyRequestProcessor processor) {
        this.broker = broker;
    ...
    public String getServiceName() {
        if (broker.getBrokerConfig().isInBrokerContainer()) {
            return broker.getBrokerIdentity().getIdentifier() + PopLongPollingService.class.getSimpleName();
        }
