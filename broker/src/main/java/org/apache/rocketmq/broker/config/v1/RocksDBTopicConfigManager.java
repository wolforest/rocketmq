...
import org.apache.rocketmq.broker.config.RocksDBConfigManager;
...
public class RocksDBTopicConfigManager extends TopicConfigManager {
    ...
    public RocksDBTopicConfigManager(Broker broker) {
        super(broker, false);
        this.rocksDBConfigManager = new RocksDBConfigManager(rocksdbConfigFilePath(), broker.getMessageStoreConfig().getMemTableFlushIntervalMs(),
            CompressionType.getCompressionType(broker.getMessageStoreConfig().getRocksdbCompressionType()));
    }
