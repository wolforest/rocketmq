        ...
        try {
            ...
            if (commandLine.hasOption('b')) {
                ...
                if (commandLine.hasOption('t')) {
                    ...
                    IOUtils.string2FileNotSafe(JSON.toJSONString(topicConfigSerializeWrapper, true), filePath);
                    ...
                    SubscriptionGroupWrapper subscriptionGroupWrapper = defaultMQAdminExt.getUserSubscriptionGroup(
                        brokerAddr, 10000L);
                    IOUtils.string2FileNotSafe(JSON.toJSONString(subscriptionGroupWrapper, true), filePath);
                    System.out.printf("export %s success", filePath);
                }
                ...
                IOUtils.string2FileNotSafe(JSON.toJSONString(result, true), exportPath);
