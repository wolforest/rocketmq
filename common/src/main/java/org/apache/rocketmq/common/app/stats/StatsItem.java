...
package org.apache.rocketmq.common.app.stats;
...
public class StatsItem {
    ...
    public void init() {
        ...
        }, Math.abs(TimeUtils.computeNextMinutesTimeMillis() - System.currentTimeMillis()), 1000 * 60, TimeUnit.MILLISECONDS);
        ...
        }, Math.abs(TimeUtils.computeNextMorningTimeMillis() - System.currentTimeMillis()) - 2000, 1000 * 60 * 60 * 24, TimeUnit.MILLISECONDS);
    }
