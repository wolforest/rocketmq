...
public class IndexFile {
    ...
    private long calculateTimeDiff(long storeTimestamp) {
    ...
    private int getSlotValue(int absSlotPos) {
    ...
    private void updateMappedByteBuffer(long storeTimestamp, int keyHash, long phyOffset, int slotValue, int absSlotPos) {
        long timeDiff = calculateTimeDiff(storeTimestamp);
    ...
    private void updateIndexHeader(long storeTimestamp, long phyOffset, int slotValue) {
    ...
    public boolean putKey(final String key, final long phyOffset, final long storeTimestamp) {
        ...
        try {
            int slotValue = getSlotValue(absSlotPos);
            updateMappedByteBuffer(storeTimestamp, keyHash, phyOffset, slotValue, absSlotPos);
            updateIndexHeader(storeTimestamp, phyOffset, slotValue);
            return true;
        } catch (Exception e) {
    ...
    private void addPhyOffset(List<Long> phyOffsets, int maxNum, long begin, long end, int slotValue, int keyHash) {
