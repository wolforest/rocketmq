...
public class TimerMessageStore {
    ...
    public void initService() {
        ...
        for (int i = 0; i < timerMessageDelivers.length; i++) {
            timerMessageDelivers[i] = new TimerMessageDeliver(this, timerMetricManager, timerMessageDeliverQueue, perfCounterTicks,timerState,storeConfig,getServiceThreadName());
        }
