...
package org.apache.rocketmq.store.infra.ha.autoswitch;
...
import org.apache.rocketmq.store.infra.ha.GroupTransferService;
import org.apache.rocketmq.store.infra.ha.HAClient;
import org.apache.rocketmq.store.infra.ha.HAConnection;
import org.apache.rocketmq.store.infra.ha.HAConnectionStateNotificationService;
...
public class AutoSwitchHAService extends DefaultHAService {
    ...
    public void updateConnectionLastCaughtUpTime(final Long slaveBrokerId, final long lastCaughtUpTimeMs) {
        Long prevTime = MapUtils.computeIfAbsent(this.connectionCaughtUpTimeTable, slaveBrokerId, k -> 0L);
