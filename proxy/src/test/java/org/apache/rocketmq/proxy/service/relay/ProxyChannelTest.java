...
public class ProxyChannelTest {
    ...
    public void testWriteAndFlush() throws Exception {
        ...
        transactionMessageExt.setBornHost(NetworkUtils.string2SocketAddress("127.0.0.2:8888"));
        transactionMessageExt.setStoreHost(NetworkUtils.string2SocketAddress("127.0.0.1:10911"));
        ...
        consumeMessageDirectlyMessageExt.setBornHost(NetworkUtils.string2SocketAddress("127.0.0.2:8888"));
        consumeMessageDirectlyMessageExt.setStoreHost(NetworkUtils.string2SocketAddress("127.0.0.1:10911"));
